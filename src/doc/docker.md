...
sudo docker run --rm -it --network=host mikhailbolshakov/camunda-tomcat

sudo docker run --rm -it --network=host -e CAMUNDA_LOG_DIR='$HOME/logs' -e CAMUNDA_LOG_LEVEL='DEBUG' mikhailbolshakov/camunda-tomcat
